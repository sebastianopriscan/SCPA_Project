...
int SCPA_CSR_DIRECT_LOADER_Init(IN FILE *file, INOUT SCPA_MMLOADER_CSR_LOADER_DATA *out) ;
int SCPA_CSR_DIRECT_LOADER_Destroy(IN SCPA_MMLOADER_CSR_LOADER_DATA *loader) ;

int SCPA_CSR_TRANSPOSED_LOADER_Init(IN FILE *file, INOUT SCPA_MMLOADER_CSR_LOADER_DATA *out) ;
int SCPA_CSR_TRANSPOSED_LOADER_Destroy(IN SCPA_MMLOADER_CSR_LOADER_DATA *loader) ;

int SCPA_HLL_DIRECT_LOADER_Init(IN FILE *file, INOUT SCPA_MMLOADER_HLL_LOADER_DATA *out, int hackSize) ;
